...
class MultiCityFlight:
    def __init__(self, driver):
        ...
        self.addCityButton1 = "//body/div[@id='__next']/div[1]/div[2]/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/div[3]/div[1]/form[1]/div[1]/div[2]/div[1]/div[3]/button[1]"
    ...
    def input_multi_city_flying_from2(self, flying_from_country2):
        ...
        self.driver.find_element(By.XPATH, self.flyingFromMultiCity2).clear()
    ...
    def input_multi_city_flying_to2(self, flying_to_country2):
        self.driver.find_element(By.XPATH, self.flyingToMultiCity2).click()
        self.driver.find_element(By.XPATH, self.flyingToMultiCity2).clear()
        self.driver.find_element(By.XPATH, self.flyingToMultiCity2).send_keys(flying_to_country2)
        driver = self.driver
        action = ActionChains(driver)
        action.send_keys(Keys.ARROW_DOWN).perform()
        time.sleep(2)
    ...
    def add_city_1(self):
        self.driver.find_element(By.XPATH, self.addCityButton1).click()
    ...
    def input_multi_city_flying_from3(self, flying_from_country3):
        ...
        self.driver.find_element(By.XPATH, self.flyingToMultiCity3).clear()
    ...
    def input_multi_city_flying_to3(self, flying_to_country3):
        self.driver.find_element(By.XPATH, self.flyingToMultiCity3).click()
        self.driver.find_element(By.XPATH, self.flyingToMultiCity3).send_keys(flying_to_country3)
        driver = self.driver
        action = ActionChains(driver)
        action.send_keys(Keys.ARROW_DOWN).perform()
        time.sleep(2)
